...
const Navbar = () => {
    ...
    return (
        <nav className="flex justify-between w-full cursor-pointer py-6 item-center navbar">
            ...
            <ul className="list-none sm:flex hidden justify-end item-center flex-1">
                {navLinks.map((nav, index) => (
                    <li
                        key={nav.id}
                        className={`font-poppins font-normal hover:text-secondary cursor-pointer 
